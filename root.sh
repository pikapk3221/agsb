...
# 更新系统并安装软件包
apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install -y curl wget git vim nano htop tmux expect python3 python3-pip nodejs npm net-tools zip unzip sudo locales tree ca-certificates gnupg lsb-release iproute2 cron
